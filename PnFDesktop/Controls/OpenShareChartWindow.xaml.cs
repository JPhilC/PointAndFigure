...
namespace PnFDesktop.Controls
{
    ...
    /// </summary>
    public partial class OpenShareChartWindow : Window
    {
        private OpenShareChartViewModel _viewModel;

        public OpenShareChartWindow(OpenShareChartViewModel viewModel)
        {
