...
namespace PnFData.Migrations
{
    ...
    [Migration("20221009202125_Adding_8dayEma_Calcs")]
    partial class Adding_8dayEma_Calcs
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PnFData.Model.Eod", b =>
                {
                    ...
                    b.ToTable("EodPrices", t =>
                    {
                        t.HasTrigger("EodPrices_UPDATE");
                    });
                });
            ...
            modelBuilder.Entity("PnFData.Model.IndexChart", b =>
                {
                    ...
                    b.ToTable("IndexCharts", t =>
                    {
                        t.HasTrigger("IndexCharts_UPDATE");
                    });
                });
            ...
            modelBuilder.Entity("PnFData.Model.IndexIndicator", b =>
                {
                    ...
                    b.Property<bool?>("BullishPercentDoubleBottom")
                        .HasColumnType("bit");

                    b.Property<bool?>("BullishPercentDoubleTop")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("IndexIndicators", t =>
                    {
                        t.HasTrigger("IndexIndicators_UPDATE");
                    });
                });
            ...
            modelBuilder.Entity("PnFData.Model.IndexRSI", b =>
                {
                    ...
                    b.ToTable("IndexRSIValues", t =>
                    {
                        t.HasTrigger("IndiceRSIValues_UPDATE");
                    });
                });
            ...
            modelBuilder.Entity("PnFData.Model.IndexValue", b =>
                {
                    ...
                    b.ToTable("IndexValues", t =>
                    {
                        t.HasTrigger("IndexValues_UPDATE");
                    });
                });
            ...
            modelBuilder.Entity("PnFData.Model.PnFBox", b =>
                {
                    ...
                    b.ToTable("PnFBoxes", t =>
                    {
                        t.HasTrigger("PnFBoxes_UPDATE");
                    });
                });
            ...
            modelBuilder.Entity("PnFData.Model.PnFChart", b =>
                {
                    ...
                    b.ToTable("PnFCharts", t =>
                    {
                        t.HasTrigger("PnFCharts_UPDATE");
                    });
                });
            ...
            modelBuilder.Entity("PnFData.Model.PnFColumn", b =>
                {
                    ...
                    b.ToTable("PnFColumns", t =>
                    {
                        t.HasTrigger("PnFColumns_UPDATE");
                    });
                });
            ...
            modelBuilder.Entity("PnFData.Model.PnFSignal", b =>
                {
                    ...
                    b.ToTable("PnFSignals", t =>
                    {
                        t.HasTrigger("PnFSignals_UPDATE");
                    });
                });
            ...
            modelBuilder.Entity("PnFData.Model.Portfolio", b =>
                {
                    ...
                    {
                        t.HasTrigger("Portfolios_UPDATE");
                    });
                });

            modelBuilder.Entity("PnFData.Model.PortfolioEventResult", b =>
                {
                    b.Property<double>("AdjustedClose")
                        .HasColumnType("float");
                    ...
                    b.ToTable("PortfolioEventResults");
                });
            ...
            modelBuilder.Entity("PnFData.Model.PortfolioShare", b =>
                {
                    ...
                    b.ToTable("PortfolioShares", t =>
                    {
                        t.HasTrigger("PortfolioShares_UPDATE");
                    });
                });
            ...
            modelBuilder.Entity("PnFData.Model.Share", b =>
                {
                    ...
                    b.Property<double?>("BeneishMScore")
                        .HasColumnType("float");

                    b.Property<double?>("CROCI")
                        .HasColumnType("float");
                    ...
                    b.Property<double?>("DebtToMarketCap")
                        .HasColumnType("float");

                    b.Property<double?>("DividendYearsGrowth")
                        .HasColumnType("float");

                    b.Property<double?>("DividendYearsPaid")
                        .HasColumnType("float");
                    ...
                    b.Property<double?>("FixChargeCover")
                        .HasColumnType("float");

                    b.Property<double?>("ForecastYield")
                        .HasColumnType("float");

                    b.Property<double?>("ForecastYieldChange")
                        .HasColumnType("float");

                    b.Property<double?>("FreeCashConversion")
                        .HasColumnType("float");
                    ...
                    b.Property<double?>("PensionToMarketCap")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("PnFData.Model.ShareChart", b =>
                {
                    ...
                    b.ToTable("ShareCharts", t =>
                    {
                        t.HasTrigger("ShareCharts_UPDATE");
                    });
                });
            ...
            modelBuilder.Entity("PnFData.Model.ShareIndicator", b =>
                {
                    ...
                    b.Property<bool?>("ClosedAboveEma8d")
                        .HasColumnType("bit");
                    ...
                    b.Property<double?>("Ema5")
                        .HasColumnType("float");

                    b.Property<double?>("Ema8d")
                        .HasColumnType("float");

                    b.Property<bool?>("Falling")
                        .HasColumnType("bit");

                    b.Property<bool?>("MomentumFalling")
                        .HasColumnType("bit");

                    b.Property<bool?>("MomentumRising")
                        .HasColumnType("bit");
                    ...
                    b.Property<double?>("WeeklyMomentum")
                        .HasColumnType("float");
                    ...
                    b.ToTable("ShareIndicators", t =>
                    {
                        t.HasTrigger("ShareIndicators_UPDATE");
                    });
                });
            ...
            modelBuilder.Entity("PnFData.Model.ShareRSI", b =>
                {
                    ...
                    b.ToTable("ShareRSIValues", t =>
                    {
                        t.HasTrigger("ShareRSIValues_UPDATE");
                    });
                });

            modelBuilder.Entity("PnFData.Model.StdDevResult", b =>
                {
